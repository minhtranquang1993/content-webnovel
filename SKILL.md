...
- **Câu mở:** góc chính định hình cách mở (vd góc Nhân vật → mở bằng nhân vật; góc Cảm xúc → mở bằng cảm giác đọc). **BẮT BUỘC vẫn có câu định nghĩa entity** ("[Tên] là truyện [thể loại] của [tác giả]…") ở đâu đó trong đoạn mở cho AEO.
...
3. `<h1>` — `Review [Tên truyện] – [thể loại] [năm]`
4. Đoạn mở: **câu mở theo góc chính** + câu định nghĩa entity → **1 self-link** về URL bài → TL;DR 2-3 câu. Ngay dưới chèn **1 ảnh ImgBB** (nếu có).
